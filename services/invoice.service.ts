        ...
        return new Promise<{
            ...
            async (
                ...
                try {
                    ...
                    const invoiceNo = `INV-${safeOrderId
                        .slice(-6)
                        .toUpperCase()}`;
                    ...
                    const drawHeader =
                        () => {
                            ...
                            doc.font("Bold")
                                .fontSize(20)
                                .fillColor(TEXT)
                                .text("YASH MAWA BHANDAR", 40, 52);

                            doc.font("Regular")
                                .fontSize(9)
                                .fillColor(TEXT)
                                .text(`GSTIN ${process.env.GST_NUMBER || "-"}`, 40, 82)
                                .text("BARAUT, Tyodhi", 40, 96)
                                .text("Bagpat, UTTAR PRADESH, 250611", 40, 110)
                                .text(`Mobile +91 ${process.env.CONTACT_NUMBER || "-"}`, 40, 124);

                            doc.image(logoBuffer, 430, 30, {
                                width: 100,
                            });

                            doc.font("Bold")
                                .fontSize(10)
                                .text(`Invoice #: ${invoiceNo}`, 40, 165);
                            ...
                            doc.font("Bold")
                                .fontSize(10)
                                .text("Customer Details:", 40, 205);

                            doc.font("Regular")
                                .fontSize(9)
                                .text(address.fullName || "Customer", 40, 223)
                                .text(billingAddress, 40, 238, {
                                    width: 180,
                                })
                            ...
                            doc.font("Bold")
                                .fontSize(10)
                                .text("Billing Address:", 250, 205);

                            doc.font("Regular")
                                .fontSize(9)
                                .text(billingAddress, 250, 223, {
                                    width: 220,
                                });
                        };
                    ...
                    const drawTableHeader = (top: number) => {
                        ...
                        headers.forEach((h, i) => {
                            doc.text(h, positions[i], top + 8);
                        });

                        doc.moveTo(40, top + 24)
                            .lineTo(555, top + 24)
                            .strokeColor(BORDER)
                            .stroke();
                    ...
                    doc.font(
                        ...
                        .fontSize(8)
                        .text(
                            `Total Items / Qty : ${order.items.length} / ${totalQty}`,
                            40,
                            y
                        );
                    ...
                    doc.font(
                        ...
                        .text(
                            "Thank You for Shopping with Yash Mawa Bhandar!",
                            40,
                            y +
                            20
                        );
